...
from utils import gen_group_graph, gen_graph, gen_b, extract_community, gen_beta, computeCosSim, extract_community_spectralClustering
...
if __name__ == '__main__':
    ...
    parser.add_argument('--proj',          type=int,   default=1, help='whether to do projection')
    parser.add_argument('--traj',          type=int,   default=0, help='whether to collect trajectories')
    ...
    ind_game = LQGame(n, b_vec, adj, pe_vec, M=M, N=N, ub=1.0)
    ...
    group_game  = LQGame(nG, bG_vec, adjG, peG_vec, ub=1.0)
